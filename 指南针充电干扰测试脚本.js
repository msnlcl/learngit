...
events.onKeyDown("volume_up", function (event) {
  ...
  log("充电与非充电状态下，指南针X轴总体偏差：" + String(Math.max.apply(Math, angx_all) - Math.min.apply(Math, angx_all)));
  log("充电与非充电状态下，指南针Y轴总体偏差：" + String(Math.max.apply(Math, angy_all) - Math.min.apply(Math, angy_all)));
  log("充电与非充电状态下，指南针Z轴总体偏差：" + String(Math.max.apply(Math, angz_all) - Math.min.apply(Math, angz_all)));
log(angx_all.length);
log(angx_c.length);
log(angx.length);
...
var angx_all = new Array();
var angy_all = new Array();
var angz_all = new Array();
